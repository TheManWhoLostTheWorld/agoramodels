...
def test_twitter_link_header(driver, open_website, wait):
    ...
    twitter = wait.until(EC.element_to_be_clickable((By.XPATH, TWITTER_BUTTON_HEADER)))
    twitter.click()

    load = wait.until(EC.presence_of_all_elements_located((By.XPATH, TWITTER_LOAD)))
...
def test_link_facebook_header(driver, open_website, wait):
    ...
    facebook = wait.until(EC.element_to_be_clickable((By.XPATH, FACEBOOK_BUTTON_HEADER))).click()

    load = wait.until(EC.presence_of_all_elements_located((By.XPATH, FACEBOOK_LOAD)))
...
def test_link_youtube_header(driver, open_website, wait):
    ...
    youtube = wait.until(EC.element_to_be_clickable((By.XPATH, YOUTUBE_BUTTON_HEADER))).click()

    button_accept_cookies = wait.until(EC.element_to_be_clickable((By.XPATH, YOUTUBE_ACCEPT_BUTTON)))
    ActionChains(driver)\
    ...
    load = wait.until(EC.presence_of_all_elements_located((By.XPATH, YOUTUBE_LOAD)))
...
def test_link_instagram_header(driver, open_website, wait):
    ...
    instagram = wait.until(EC.element_to_be_clickable((By.XPATH, INSTAGRAM_BUTTON_HEADER))).click()

    load = wait.until(EC.presence_of_all_elements_located((By.XPATH, INSTAGRAM_LOAD)))
...
def test_facebook_link_footer(driver, open_website, wait):
    ...
    facebook = wait.until(EC.element_to_be_clickable((By.XPATH, FACEBOOK_BUTTON_HEADER)))

    driver.execute_script("window.scrollBy(0,document.body.scrollHeight)")
    time.sleep(1)
    footer_facebook = driver.find_element(By.XPATH, FACEBOOK_BUTTON_FOOTER).click()
...
def test_youtube_link_footer(driver, open_website, wait):
    ...
    youtube = wait.until(EC.element_to_be_clickable((By.XPATH, YOUTUBE_BUTTON_HEADER)))

    driver.execute_script("window.scrollBy(0,document.body.scrollHeight)")
    time.sleep(1)
    footer_youtube = driver.find_element(By.XPATH, YOUTUBE_BUTTON_FOOTER).click()
...
def test_instagram_link_footer(driver, open_website, wait):
    instagram = wait.until(EC.element_to_be_clickable((By.XPATH, INSTAGRAM_BUTTON_HEADER)))
